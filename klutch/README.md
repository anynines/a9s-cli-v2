...
- The following external resources are reachable:
    ...
    - https://anynines-artifacts.s3.eu-central-1.amazonaws.com/central-management/v1.5.0/crds.yaml
...
- `kubectl` and the `kubectl-bind` plugin (`v1.5.0`) are present in the PATH.
